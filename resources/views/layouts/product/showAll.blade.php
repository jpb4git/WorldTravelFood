                    ...
                    <a class="product-a" href="/product/{{$product->id}}">
                        <div class="card text-center mb-3">
                            <div class="text-center pt-2">
                                <img src="{{asset('/assets/images/'.$product->urlimage)}}" class="card-img-top w-50 "
                                     alt="product 1 ">
                            </div>
                            <div class="card-body">
                                <h5 class="card-title"><strong>{{$product->label}}</strong></h5>
                                <h6 class="card-title">{{$product->label}}</h6>
